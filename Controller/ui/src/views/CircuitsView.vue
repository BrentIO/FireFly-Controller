          ...
          <div class="w-full max-w-md bg-white dark:bg-gray-900 rounded-xl shadow-xl p-6 max-h-[90vh] overflow-y-auto">
            ...
            <form @submit.prevent="save" class="space-y-4">
              ...
              <div>
                ...
                <input v-model.number="form.load_amperage" type="number" min="0.1" max="100" step="0.1" required
                  class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
              <div v-if="selectedRelayIsVariable">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Start Brightness <span class="text-xs font-normal text-gray-400">(5–100%, applied when INCREASE turns on from off)</span></label>
