<template>
  <AppLayout>
    <div class="flex items-center justify-between mb-6 print:mb-4">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 print:text-xl">Colors</h1>
      <button
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-x-auto">
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
          ...
          <tr v-for="color in sortedColors" :key="color.id" class="hover:bg-gray-50 dark:hover:bg-gray-800/50 even:bg-gray-50 dark:even:bg-gray-800/50">
          ...
          <div class="w-full max-w-sm bg-white dark:bg-gray-900 rounded-xl shadow-xl p-6">
            ...
            <form @submit.prevent="save">
              ...
              <div class="flex items-center gap-3 mb-4">
                ...
                <span class="text-sm text-gray-600 dark:text-gray-400 font-mono">{{ form.hex }}</span>
              </div>
    ...
    <ConfirmModal
      :show="!!deleteTarget"
      title="Delete Color"
      :message="`Delete color '${deleteTarget?.name}'? This cannot be undone.`"
...
const form = ref({ name: '', hex: '#ffffff' })
...
function openAdd() {
  editing.value = null
  form.value = { name: '', hex: '#ffffff' }
  showModal.value = true
}

function openEdit(color) {
  editing.value = color
  form.value = { name: color.name, hex: color.hex }
  showModal.value = true
}
