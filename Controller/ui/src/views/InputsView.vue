    ...
    <section class="mb-8 print:hidden">
      ...
      >
        ...
        >
          ...
          <span v-if="primaryBySecondaryId.has(client.id)" class="mt-1 px-1.5 py-0.5 text-[10px] font-semibold rounded bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300 leading-none">Extended</span>
        </div>
      </div>
        ...
        >
          ...
          <div class="flex-1 flex flex-col items-center justify-center text-center px-2 pb-1">
            <template v-if="port.client">
              ...
              <span v-if="primaryBySecondaryId.has(port.client.id)" class="mt-1 px-1.5 py-0.5 text-[10px] font-semibold rounded bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300 leading-none print:!bg-purple-100 print:!text-purple-700">Extended</span>
