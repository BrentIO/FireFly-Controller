    ...
    #define WORD_LENGTH_DEVICE_AUTOMATION 17                            //len("device_automation")
    #define WORD_LENGTH_CHANNEL 7                                       //len("channel")
    #define WORD_LENGTH_INPUT_TRIGGER_TYPE 18                           //len("button_short_press") — longest trigger type

    //Ex: homeassistant/device_automation/FireFly-12345678-channel-4-button_short_press/config
    #define MQTT_TOPIC_INPUT_AUTO_DISCOVERY_PATTERN "%s/device_automation/FireFly-%s-channel-%i-%s/config"   //%s = HA root, %s = port ID, %i = logical channel, %s = trigger type
    #define MQTT_TOPIC_INPUT_AUTO_DISCOVERY_LENGTH WORD_LENGTH_AUTODISCOVERY_ROOT + WORD_LENGTH_SLASH + WORD_LENGTH_DEVICE_AUTOMATION + WORD_LENGTH_SLASH + WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + PORT_ID_MAX_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_CHANNEL + WORD_LENGTH_DASH + CHANNEL_NUMBER_MAX_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUT_TRIGGER_TYPE + WORD_LENGTH_SLASH + WORD_LENGTH_CONFIG

    //Ex: FireFly-12345678-channel-4-button_short_press
    #define MQTT_INPUT_AUTO_DISCOVERY_UNIQUE_ID_PATTERN "FireFly-%s-channel-%i-%s"   //%s = port ID, %i = logical channel, %s = trigger type
    #define MQTT_INPUT_AUTO_DISCOVERY_UNIQUE_ID_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + PORT_ID_MAX_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_CHANNEL + WORD_LENGTH_DASH + CHANNEL_NUMBER_MAX_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUT_TRIGGER_TYPE

    //Ex: FireFly-inputs-12345678
    #define MQTT_INPUT_AUTO_DISCOVERY_DEVICE_ID_PATTERN "FireFly-inputs-%s"   //%s = port ID
    #define MQTT_INPUT_AUTO_DISCOVERY_DEVICE_ID_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + WORD_LENGTH_INPUTS + WORD_LENGTH_DASH + PORT_ID_MAX_LENGTH

    //Ex: channel-4
    #define MQTT_INPUT_AUTO_DISCOVERY_SUBTYPE_PATTERN "channel-%i"   //%i = logical channel number
    #define MQTT_INPUT_AUTO_DISCOVERY_SUBTYPE_LENGTH WORD_LENGTH_CHANNEL + WORD_LENGTH_DASH + CHANNEL_NUMBER_MAX_LENGTH
