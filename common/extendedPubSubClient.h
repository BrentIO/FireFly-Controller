    ...
    //Ex: FireFly/00000000-0000-4000-0000-000000000000/inputs/controller/0/availability
    #define MQTT_TOPIC_INPUT_CONTROLLER_AVAILABILITY_PATTERN WORD_FIREFLY_SLASH "%s/inputs/controller/%u/availability"   //%s = Controller UUID, %u = chip I2C address
    #define MQTT_TOPIC_INPUT_CONTROLLER_AVAILABILITY_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_SLASH + UUID_LENGTH + WORD_LENGTH_SLASH + WORD_LENGTH_INPUTS + WORD_LENGTH_SLASH + WORD_LENGTH_CONTROLLER + WORD_LENGTH_SLASH + OUTPUT_CONTROLLER_ADDRESS_MAX_DIGITS + WORD_LENGTH_SLASH + WORD_LENGTH_AVAILABILITY

    #define WORD_LENGTH_CHANNEL 7                                       //len("channel")
    #define WORD_LENGTH_SENSOR 6                                        //len("sensor")

    //Ex: homeassistant/sensor/FireFly-00000000-0000-4000-0000-000000000000-inputs-12345678-channel-4/config
    #define MQTT_TOPIC_INPUT_AUTO_DISCOVERY_PATTERN "%s/sensor/FireFly-%s-inputs-%s-channel-%i/config"   //%s = HA root, %s = controller UUID, %s = port ID, %i = logical channel number
    #define MQTT_TOPIC_INPUT_AUTO_DISCOVERY_LENGTH WORD_LENGTH_AUTODISCOVERY_ROOT + WORD_LENGTH_SLASH + WORD_LENGTH_SENSOR + WORD_LENGTH_SLASH + WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUTS + WORD_LENGTH_DASH + PORT_ID_MAX_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_CHANNEL + WORD_LENGTH_DASH + CHANNEL_NUMBER_MAX_LENGTH + WORD_LENGTH_SLASH + WORD_LENGTH_CONFIG

    //Ex: FireFly-00000000-0000-4000-0000-000000000000-inputs-12345678-channel-4
    #define MQTT_INPUT_AUTO_DISCOVERY_UNIQUE_ID_PATTERN "FireFly-%s-inputs-%s-channel-%i"   //%s = controller UUID, %s = port ID, %i = logical channel number
    #define MQTT_INPUT_AUTO_DISCOVERY_UNIQUE_ID_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUTS + WORD_LENGTH_DASH + PORT_ID_MAX_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_CHANNEL + WORD_LENGTH_DASH + CHANNEL_NUMBER_MAX_LENGTH

    //Ex: sensor.FireFly-00000000-0000-4000-0000-000000000000-inputs-12345678-channel-4
    #define MQTT_INPUT_AUTO_DISCOVERY_DEFAULT_ENTITY_ID_PATTERN "sensor.FireFly-%s-inputs-%s-channel-%i"   //%s = controller UUID, %s = port ID, %i = logical channel number
    #define MQTT_INPUT_AUTO_DISCOVERY_DEFAULT_ENTITY_ID_LENGTH WORD_LENGTH_SENSOR + WORD_LENGTH_DOT + WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUTS + WORD_LENGTH_DASH + PORT_ID_MAX_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_CHANNEL + WORD_LENGTH_DASH + CHANNEL_NUMBER_MAX_LENGTH

    //Ex: FireFly-00000000-0000-4000-0000-000000000000-inputs-12345678
    #define MQTT_INPUT_AUTO_DISCOVERY_DEVICE_ID_PATTERN "FireFly-%s-inputs-%s"   //%s = controller UUID, %s = port ID
    #define MQTT_INPUT_AUTO_DISCOVERY_DEVICE_ID_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUTS + WORD_LENGTH_DASH + PORT_ID_MAX_LENGTH

    //Ex: FireFly-00000000-0000-4000-0000-000000000000
    #define MQTT_INPUT_AUTO_DISCOVERY_CLIENT_DEVICE_ID_PATTERN "FireFly-%s"   //%s = client UUID
    #define MQTT_INPUT_AUTO_DISCOVERY_CLIENT_DEVICE_ID_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH

    //Ex: homeassistant/sensor/FireFly-00000000-0000-4000-0000-000000000000-inputs-controller-32/config
    #define MQTT_TOPIC_INPUT_CONTROLLER_AUTO_DISCOVERY_PATTERN "%s/sensor/FireFly-%s-inputs-controller-%u/config"   //%s = HA root, %s = controller UUID, %u = chip I2C address
    #define MQTT_TOPIC_INPUT_CONTROLLER_AUTO_DISCOVERY_LENGTH WORD_LENGTH_AUTODISCOVERY_ROOT + WORD_LENGTH_SLASH + WORD_LENGTH_SENSOR + WORD_LENGTH_SLASH + WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUTS + WORD_LENGTH_DASH + WORD_LENGTH_CONTROLLER + WORD_LENGTH_DASH + OUTPUT_CONTROLLER_ADDRESS_MAX_DIGITS + WORD_LENGTH_SLASH + WORD_LENGTH_CONFIG

    //Ex: FireFly-00000000-0000-4000-0000-000000000000-inputs-controller-32
    #define MQTT_INPUT_CONTROLLER_AUTO_DISCOVERY_UNIQUE_ID_PATTERN "FireFly-%s-inputs-controller-%u"   //%s = controller UUID, %u = chip I2C address
    #define MQTT_INPUT_CONTROLLER_AUTO_DISCOVERY_UNIQUE_ID_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUTS + WORD_LENGTH_DASH + WORD_LENGTH_CONTROLLER + WORD_LENGTH_DASH + OUTPUT_CONTROLLER_ADDRESS_MAX_DIGITS

    //Ex: sensor.FireFly-00000000-0000-4000-0000-000000000000-inputs-controller-32
    #define MQTT_INPUT_CONTROLLER_AUTO_DISCOVERY_DEFAULT_ENTITY_ID_PATTERN "sensor.FireFly-%s-inputs-controller-%u"   //%s = controller UUID, %u = chip I2C address
    #define MQTT_INPUT_CONTROLLER_AUTO_DISCOVERY_DEFAULT_ENTITY_ID_LENGTH WORD_LENGTH_SENSOR + WORD_LENGTH_DOT + WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_INPUTS + WORD_LENGTH_DASH + WORD_LENGTH_CONTROLLER + WORD_LENGTH_DASH + OUTPUT_CONTROLLER_ADDRESS_MAX_DIGITS

    //Ex: homeassistant/sensor/FireFly-00000000-0000-4000-0000-000000000000-outputs-controller-64/config
    #define MQTT_TOPIC_OUTPUT_CONTROLLER_AUTO_DISCOVERY_PATTERN "%s/sensor/FireFly-%s-outputs-controller-%u/config"   //%s = HA root, %s = controller UUID, %u = chip I2C address
    #define MQTT_TOPIC_OUTPUT_CONTROLLER_AUTO_DISCOVERY_LENGTH WORD_LENGTH_AUTODISCOVERY_ROOT + WORD_LENGTH_SLASH + WORD_LENGTH_SENSOR + WORD_LENGTH_SLASH + WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_OUTPUTS + WORD_LENGTH_DASH + WORD_LENGTH_CONTROLLER + WORD_LENGTH_DASH + OUTPUT_CONTROLLER_ADDRESS_MAX_DIGITS + WORD_LENGTH_SLASH + WORD_LENGTH_CONFIG

    //Ex: FireFly-00000000-0000-4000-0000-000000000000-outputs-controller-64
    #define MQTT_OUTPUT_CONTROLLER_AUTO_DISCOVERY_UNIQUE_ID_PATTERN "FireFly-%s-outputs-controller-%u"   //%s = controller UUID, %u = chip I2C address
    #define MQTT_OUTPUT_CONTROLLER_AUTO_DISCOVERY_UNIQUE_ID_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_OUTPUTS + WORD_LENGTH_DASH + WORD_LENGTH_CONTROLLER + WORD_LENGTH_DASH + OUTPUT_CONTROLLER_ADDRESS_MAX_DIGITS

    //Ex: sensor.FireFly-00000000-0000-4000-0000-000000000000-outputs-controller-64
    #define MQTT_OUTPUT_CONTROLLER_AUTO_DISCOVERY_DEFAULT_ENTITY_ID_PATTERN "sensor.FireFly-%s-outputs-controller-%u"   //%s = controller UUID, %u = chip I2C address
    #define MQTT_OUTPUT_CONTROLLER_AUTO_DISCOVERY_DEFAULT_ENTITY_ID_LENGTH WORD_LENGTH_SENSOR + WORD_LENGTH_DOT + WORD_LENGTH_FIREFLY + WORD_LENGTH_DASH + UUID_LENGTH + WORD_LENGTH_DASH + WORD_LENGTH_OUTPUTS + WORD_LENGTH_DASH + WORD_LENGTH_CONTROLLER + WORD_LENGTH_DASH + OUTPUT_CONTROLLER_ADDRESS_MAX_DIGITS
    ...
    //Ex: FireFly/00000000-0000-4000-0000-000000000000/temperature/12345678/availability
    #define MQTT_TOPIC_TEMPERATURE_AVAILABILITY_PATTERN WORD_FIREFLY_SLASH "%s/temperature/%s/availability"   //%s = Controller UUID, %s = location
    #define MQTT_TOPIC_TEMPERATURE_AVAILABILITY_LENGTH WORD_LENGTH_FIREFLY + WORD_LENGTH_SLASH + UUID_LENGTH + WORD_LENGTH_SLASH + WORD_LENGTH_TEMPERATURE + WORD_LENGTH_SLASH + TEMPERATURE_SENSOR_LOCATION_MAX_LENGTH + WORD_LENGTH_SLASH + WORD_LENGTH_AVAILABILITY
