...
#define IO_EXTENDER_INTERRUPT_PINS {34,35,32,33,5,18,19,23} /* Interrupt pins for the IO extenders, order must match the ADDRESSES_IO_EXTENDER */
...
#define OUTPUT_CONTROLLER_PORTS {1,2,4,3,5,6,8,7,9,10,12,11,13,14,16,15,17,18,20,19,21,22,24,23,25,26,28,27,29,30,32,31} /* Physical mapping of the output port numbers in sequence by output controller address, based on the output controllers' pin numbers */
...
#define OLED_BUTTON_PIN 15 /* Button for the front panel */
...
#define ETHERNET_PIN_RESET 27 /* Ethernet hardware reset pin */
#define ETHERNET_PIN_INTERRUPT 26 /* Ethernet hardware interrupt pin */
